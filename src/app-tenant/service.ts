...
export const deployNewMarketplace = (tenantId: string, apiKey: string, password: string, repeatPassword: string, marketplaceType: "blank", configOverwrites: { [key: string]: string }, cb: (err: any) => void) => {
  /**
